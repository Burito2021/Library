...
class UserControllerTest extends TestContainers {
    ...
    public void maxPageSizeHas100() throws Exception {
        var accessToken = getAccessToken(authService, ADMIN_USER2, PASSWORD_ADMIN);
    ...
    public void userNameFilterStartAndEndDate() throws Exception {
        final var accessToken = getAccessToken(authService, ADMIN_USER, PASSWORD_ADMIN);
    ...
    public void getUserByModerationStateOnReviewLowerCaseExistsInDb() throws Exception {
        var accessToken = getAccessToken(authService, "user8", PASSWORD_ADMIN);
    ...
    //-----------------
    @Test
    void appReturnsUnauthorizedWhenUserIsNotInDbAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenInvalidUsernameAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenInvalidPasswordAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenUsernameIsEmptyStringAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenUsernameIsNullAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenPasswordIsEmptyStringAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void appReturnsUnauthorizedWhenPasswordIsNullAuthLogin() throws Exception {
        final var xCorrelationId = getUUID();
    ...
    void authRefreshReturnsNewAccessTokenWhenValidRefreshToken() throws Exception {
        final var xCorrelationId = getUUID();
        final var refreshToken = getRefreshToken(authService, ADMIN_USER, PASSWORD_ADMIN);
    ...
    @Sql("classpath:sql/states.sql")
    @Test
    void authRevokeReturns200OkWhenAccessTokenIsValid() throws Exception {
        final var xCorrelationId = getUUID();
        var accessToken = getAccessToken(authService, ADMIN_USER, PASSWORD_ADMIN);
    ...
    void authLogoutReturnsUnauthorizedWhenAccessTokenIsExpired() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post(GLOBAL_BASE_URI + AUTH_LOGOUT)
                        ...
                        .contentType("application/json"))
                .andExpect(status().isUnauthorized())
                .andExpect(jsonPath("$.error", is("Token is expired")));
    }
    ...
    void appReturnsForbiddenWhenUserHasNoPermission() throws Exception {
        ...
        service.addUser(new UserRequest(username, name, surname, email, phoneNumber, address, PASSWORD_ADMIN));
        var accessToken = getAccessToken(authService, COMMON_USER, PASSWORD_USER);
    ...
    void findUserByIdNotByAdminIsForbidden() throws Exception {
        final var xCorrelationId = getUUID();
        final var accessToken = getAccessToken(authService, COMMON_USER, PASSWORD_USER);
